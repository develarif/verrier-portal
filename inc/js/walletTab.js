...
const settingTabFunc = () => {
    const getTabUl = document.querySelector('#setting-tab-header');
    const allTabBtn = document.querySelectorAll('#setting-tab-header > li');
    const tabBody = document.querySelector('.setting-tab-body');
    const allTabItem = document.querySelectorAll('.tab-item');
